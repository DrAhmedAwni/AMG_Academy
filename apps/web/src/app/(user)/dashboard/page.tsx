            ...
            <div className="space-y-2">
              {upcomingEvents.map((item) => (
                <Link
                  ...
                  className="flex items-center justify-between rounded-lg border border-surface-border bg-surface-main/60 p-3.5 transition-colors hover:bg-surface-elevated/50"
                >
